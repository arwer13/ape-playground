...
def validate_permission_create_event(event, p: Permission, manager: str) -> None:
...
def validate_permission_revoke_event(event, p: Permission) -> None:
...
def validate_permission_grant_event(event, p: Permission) -> None:
    _events_chain = ["LogScriptCall", "SetPermission"]
...
def validate_permission_grantp_event(event, p: Permission, params: List[Param]) -> None:
...
def validate_grant_role_event(events, role: str, grant_to: str, sender: str) -> None:
...
def validate_revoke_role_event(events, role: str, revoke_from: str, sender: str) -> None:
