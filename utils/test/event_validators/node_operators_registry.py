...
def validate_node_operator_added_event(
    event, node_operator_item: NodeOperatorItem
):
...
def validate_node_operator_staking_limit_set_event(
    event, node_operator_staking_limit_item: NodeOperatorStakingLimitSetItem
):
...
def validate_node_operator_name_set_event(
    event, node_operator_name_item: NodeOperatorNameSetItem
):
...
def validate_node_operator_reward_address_set_event(
    event, node_operator_reward_address_item: NodeOperatorRewardAddressSetItem
):
...
def validate_target_validators_count_changed_event(event, t: TargetValidatorsCountChanged):
