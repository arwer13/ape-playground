...
def add_evmscript_factory(factory, permissions: str) -> Tuple[str, str]:
...
def remove_evmscript_factory(factory) -> Tuple[str, str]:
    easy_track = contracts.easy_track
...
def create_permissions(contract, method: str) -> str:
